...
// type FormData = Omit<RegistrationData, "city">
...
//   const [selectedCityConfig, setSelectedCityConfig] = useState<CityConfig | null>(null)
...
//     if (newUser) {
//       setCreatedUserUID(newUser.uid) // Save the UID
//     }
//     setRegistrationData(data) // Set the final data
...
//     return <GamesPage registrationData={registrationData} onComplete={handleGamesComplete} />
//   }

//   if (currentPage === "win") {
//     return <WinPopup registrationData={registrationData} gameResults={gameResults!} onFinish={handleFinish} />
//   }

//   // Home page
//   return (
//     <div className="min-h-screen bg-black text-white overflow-hidden">
//       {cityPopupOpen && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-40" />}
...
//         <CityPopup cityConfig={selectedCityConfig} onClose={() => setCityPopupOpen(false)} onPlay={handlePlayClick} />
//       )}
//     </div>
//   )
// }
